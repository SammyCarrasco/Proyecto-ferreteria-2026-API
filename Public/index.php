<?php
    ...
    if(!isset($_GET['route'])){
        ...
        $lista = ['auth', 'user', 'productos', 'category', 'reportes', 'cotizacionDetalle', 'venta']; // agregamos 'category', 'reportes', 'cotizacionDetalle' y 'venta' a la lista de rutas permitidas
