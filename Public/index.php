<?php
    ...
    if(!isset($_GET['route'])){
        ...
        $lista = ['auth', 'user', 'productos', 'category', 'reportes', 'cotizacionDetalle', 'adminproductos', 'venta', 'inventario', 'almacenes', 'clientes', 'cotizacion']; // agregamos 'category', 'reportes', 'cotizacionDetalle' y 'venta' a la lista de rutas permitidas
